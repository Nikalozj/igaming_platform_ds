...
KAFKA_TOPIC = os.getenv("KAFKA_TOPIC_WALLET_DEPOSITS")

producer = Producer(
    {
        "bootstrap.servers": KAFKA_BOOTSTRAP_SERVERS,
        "client.id": "wallet-deposits-producer",
    }
)
...
PROVIDERS = ["stripe", "tbc_bank", "bog", "paypal"]
...
def generate_deposit_event() -> dict:
    deposit_status = choose_weighted(STATUS_WEIGHTS)
